...
class AnalysisTestCase(TestCase):
    def test_user_report_view(self):
        ...
        problem1 = Problem(desc="For test", input_desc="For test", output_desc="Fore test", pid="ITP1_6_B", objective=1)
        problem1.save()

        problem2 = Problem(desc="For test", input_desc="For test", output_desc="Fore test", pid="ITP2_3_B", objective=1)
        problem2.save()
